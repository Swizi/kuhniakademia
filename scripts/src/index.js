...
(function () {
  ...
  const social_webs_button = document.querySelector(".social_webs_button");
  const make_call_button = document.querySelector(".make_call_button");
  const free_measuring_button = document.querySelector(".book_button");
  const popup_free_measuring = document.querySelector(".popup_free_measuring");
  const price_button = document.querySelector(".price_button");
  const popup_kitchen_price = document.querySelector(".popup_kitchen_price");
  const black_window = document.querySelector(".black_window");
  const body = document.body;
  const button_next = document.querySelector(".button_next");
  const button_back = document.querySelector(".button_back");
  const button_back_form = document.querySelector(".button_back_form");
  const first_image = document.querySelector(".popup_price_image_block_first");
  const second_image = document.querySelector(".popup_price_image_block_second");
  const third_image = document.querySelector(".popup_price_image_block_third"); // startX = body.clientWidth/2,
  // startY = 300,
